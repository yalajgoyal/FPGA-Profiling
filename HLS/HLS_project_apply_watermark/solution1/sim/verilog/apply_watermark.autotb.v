...
`define AUTOTB_DUT      apply_watermark
`define AUTOTB_DUT_INST AESL_inst_apply_watermark
`define AUTOTB_TOP      apatb_apply_watermark_top
`define AUTOTB_LAT_RESULT_FILE "apply_watermark.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "apply_watermark.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_apply_watermark_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.apply_watermark.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.apply_watermark.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.apply_watermark.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.apply_watermark.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.apply_watermark.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 31731;
parameter LENGTH_input_r = 1;
parameter LENGTH_output_r = 1;
parameter LENGTH_gmem0 = 31568;
parameter LENGTH_gmem1 = 31568;
