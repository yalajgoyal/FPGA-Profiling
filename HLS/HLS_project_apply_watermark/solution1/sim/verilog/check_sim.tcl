...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.apply_watermark.autotvin_gmem0.dat"
         "c.apply_watermark.autotvin_input_r.dat"
         "c.apply_watermark.autotvin_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.apply_watermark.autotvout_gmem1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
