...
if {[file isfile apply_watermark.autotvin.dat]} {
	file delete -force apply_watermark.autotvin.dat
}

if {[file isfile apply_watermark.autotvout.dat]} {
	file delete -force apply_watermark.autotvout.dat
}
