...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2022.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2022.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2022.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/Vitis_HLS/2022.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "apply_watermark.autotvin.dat"
	set constFileTvOut       "apply_watermark.autotvout.dat"
	set constFileHdlTvIn     "apply_watermark.autohdltvin.dat"
	set constFileHdlTvOut    "apply_watermark.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
