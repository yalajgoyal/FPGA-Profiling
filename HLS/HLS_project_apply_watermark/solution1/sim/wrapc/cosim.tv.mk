...
$(ObjDir)/krnl_apply_watermark_test.cpp_pre.cpp.tb.o : krnl_apply_watermark_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling krnl_apply_watermark_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bitmap.cpp_pre.cpp.tb.o : bitmap.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bitmap.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/apply_watermark.cpp_pre.cpp.tb.o : apply_watermark.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling apply_watermark.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
