...
// ==============================================================
`timescale 1 ns / 1 ps
module apply_watermark_compute_watermark_watermark_ROM_AUTO_1R (
...
initial begin
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram0);
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram1);
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram2);
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram3);
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram4);
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram5);
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram6);
    $readmemh("./apply_watermark_compute_watermark_watermark_ROM_AUTO_1R.dat", ram7);
end
