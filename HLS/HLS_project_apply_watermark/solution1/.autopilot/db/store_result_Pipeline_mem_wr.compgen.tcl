...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outStream_dout { I 512 vector } outStream_num_data_valid { I 2 vector } outStream_fifo_cap { I 2 vector } outStream_empty_n { I 1 bit } outStream_read { O 1 bit } } \
} "
}
