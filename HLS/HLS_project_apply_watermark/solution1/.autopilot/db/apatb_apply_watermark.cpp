...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.apply_watermark.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.apply_watermark.autotvout_input_r.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.apply_watermark.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.apply_watermark.autotvout_output_r.dat"
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.apply_watermark.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.apply_watermark.autotvout_gmem0.dat"
#define AUTOTB_TVIN_gmem1 "../tv/cdatafile/c.apply_watermark.autotvin_gmem1.dat"
#define AUTOTB_TVOUT_gmem1 "../tv/cdatafile/c.apply_watermark.autotvout_gmem1.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_input_r "../tv/rtldatafile/rtl.apply_watermark.autotvout_input_r.dat"
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.apply_watermark.autotvout_output_r.dat"
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.apply_watermark.autotvout_gmem0.dat"
#define AUTOTB_TVOUT_PC_gmem1 "../tv/rtldatafile/rtl.apply_watermark.autotvout_gmem1.dat"
...
extern "C" void apply_watermark_hw_stub_wrapper(volatile void *, volatile void *);

extern "C" void apatb_apply_watermark_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
{
transaction<512> tr(31568);
aesl_fh.read(AUTOTB_TVOUT_PC_gmem1, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<64>((char*)__xlx_apatb_param_output_r, 31568, 0);
}
#else
try {
...
if (__xlx_apatb_param_input_r) {
  tr.import<64>((char*)__xlx_apatb_param_input_r, 31568, 0);
}
aesl_fh.write(AUTOTB_TVIN_gmem0, tr.p, tr.tbytes);
tcl_file.set_num(31568, &tcl_file.gmem0_depth);
}
#else
...
if (__xlx_apatb_param_output_r) {
  tr.import<64>((char*)__xlx_apatb_param_output_r, 31568, 0);
}
aesl_fh.write(AUTOTB_TVIN_gmem1, tr.p, tr.tbytes);
tcl_file.set_num(31568, &tcl_file.gmem1_depth);
}
#else
...
apply_watermark_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
