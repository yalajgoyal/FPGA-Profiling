...
set C_modelArgList {
	...
	{ sext_ln139 int 58 regular  }
	{ outStream int 512 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln139", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "outStream", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ outStream_dout sc_in sc_lv 512 signal 2 } 
	{ outStream_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ outStream_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ sext_ln139 sc_in sc_lv 58 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outStream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "outStream", "role": "dout" }} , 
 	...
 	{ "name": "sext_ln139", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln139", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln139 { ap_none {  { sext_ln139 in_data 0 58 } } }
	outStream { ap_fifo {  { outStream_dout fifo_port_we 0 512 }  { outStream_num_data_valid fifo_status_num_data_valid 0 2 }  { outStream_fifo_cap fifo_update 0 2 }  { outStream_empty_n fifo_status 0 1 }  { outStream_read fifo_data 1 1 } } }
}
