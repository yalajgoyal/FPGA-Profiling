...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inStream_din { O 512 vector } inStream_num_data_valid { I 2 vector } inStream_fifo_cap { I 2 vector } inStream_full_n { I 1 bit } inStream_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_xStream \
    op interface \
    ports { xStream_din { O 32 vector } xStream_num_data_valid { I 2 vector } xStream_fifo_cap { I 2 vector } xStream_full_n { I 1 bit } xStream_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_yStream \
    op interface \
    ports { yStream_din { O 32 vector } yStream_num_data_valid { I 2 vector } yStream_fifo_cap { I 2 vector } yStream_full_n { I 1 bit } yStream_write { O 1 bit } } \
} "
}
...
set InstName apply_watermark_flow_control_loop_pipe_sequential_init_U
set CompName apply_watermark_flow_control_loop_pipe_sequential_init
