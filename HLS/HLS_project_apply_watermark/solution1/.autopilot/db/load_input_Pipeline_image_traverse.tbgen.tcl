set moduleName load_input_Pipeline_image_traverse
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {load_input_Pipeline_image_traverse}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln78 int 58 regular  }
	{ inStream int 512 regular {fifo 1 volatile } {global 1}  }
	{ xStream int 32 regular {fifo 1 volatile } {global 1}  }
	{ yStream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "inStream", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "xStream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "yStream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ inStream_din sc_out sc_lv 512 signal 2 } 
	{ inStream_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ inStream_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ inStream_full_n sc_in sc_logic 1 signal 2 } 
	{ inStream_write sc_out sc_logic 1 signal 2 } 
	{ xStream_din sc_out sc_lv 32 signal 3 } 
	{ xStream_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ xStream_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ xStream_full_n sc_in sc_logic 1 signal 3 } 
	{ xStream_write sc_out sc_logic 1 signal 3 } 
	{ yStream_din sc_out sc_lv 32 signal 4 } 
	{ yStream_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ yStream_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ yStream_full_n sc_in sc_logic 1 signal 4 } 
	{ yStream_write sc_out sc_logic 1 signal 4 } 
	{ sext_ln78 sc_in sc_lv 58 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inStream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "inStream", "role": "din" }} , 
 	...
 	{ "name": "xStream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "xStream", "role": "din" }} , 
 	...
 	{ "name": "xStream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "xStream", "role": "full_n" }} , 
 	{ "name": "xStream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "xStream", "role": "write" }} , 
 	{ "name": "yStream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "yStream", "role": "din" }} , 
 	...
 	{ "name": "yStream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "yStream", "role": "full_n" }} , 
 	{ "name": "yStream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "yStream", "role": "write" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "31571", "Max" : "31571"}
	, {"Name" : "Interval", "Min" : "31571", "Max" : "31571"}
]}
...
set Spec2ImplPortList { 
	...
	inStream { ap_fifo {  { inStream_din fifo_port_we 1 512 }  { inStream_num_data_valid fifo_status_num_data_valid 0 2 }  { inStream_fifo_cap fifo_update 0 2 }  { inStream_full_n fifo_status 0 1 }  { inStream_write fifo_data 1 1 } } }
	xStream { ap_fifo {  { xStream_din fifo_port_we 1 32 }  { xStream_num_data_valid fifo_status_num_data_valid 0 2 }  { xStream_fifo_cap fifo_update 0 2 }  { xStream_full_n fifo_status 0 1 }  { xStream_write fifo_data 1 1 } } }
	yStream { ap_fifo {  { yStream_din fifo_port_we 1 32 }  { yStream_num_data_valid fifo_status_num_data_valid 0 2 }  { yStream_fifo_cap fifo_update 0 2 }  { yStream_full_n fifo_status 0 1 }  { yStream_write fifo_data 1 1 } } }
}
