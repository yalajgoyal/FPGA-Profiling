...
// ==============================================================
#ifndef __apply_watermark_compute_watermark_watermark_ROM_AUTO_1R_H__
#define __apply_watermark_compute_watermark_watermark_ROM_AUTO_1R_H__
...
struct apply_watermark_compute_watermark_watermark_ROM_AUTO_1R_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(apply_watermark_compute_watermark_watermark_ROM_AUTO_1R_ram) {
        for (unsigned i = 0; i < 17 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[17] = "0b10000111100001111";
        for (unsigned i = 18; i < 30 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[30] = "0b10000111100001111";
        ram[31] = "0b00000000000000000";
        ram[32] = "0b00000000000000000";
        ram[33] = "0b00000000000000000";
        ram[34] = "0b10000111100001111";
        for (unsigned i = 35; i < 45 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[45] = "0b10000111100001111";
        for (unsigned i = 46; i < 51 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[51] = "0b10000111100001111";
        for (unsigned i = 52; i < 60 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[60] = "0b10000111100001111";
        for (unsigned i = 61; i < 68 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[68] = "0b10000111100001111";
        for (unsigned i = 69; i < 75 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[75] = "0b10000111100001111";
        for (unsigned i = 76; i < 85 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[85] = "0b10000111100001111";
        ram[86] = "0b00000000000000000";
        ram[87] = "0b00000000000000000";
        ram[88] = "0b00000000000000000";
        ram[89] = "0b00000000000000000";
        ram[90] = "0b10000111100001111";
        for (unsigned i = 91; i < 102 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[102] = "0b10000111100001111";
        ram[103] = "0b00000000000000000";
        ram[104] = "0b00000000000000000";
        ram[105] = "0b10000111100001111";
        for (unsigned i = 106; i < 119 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[119] = "0b10000111100001111";
        ram[120] = "0b10000111100001111";
        for (unsigned i = 121; i < 135 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[135] = "0b10000111100001111";
        ram[136] = "0b10000111100001111";
        for (unsigned i = 137; i < 150 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[150] = "0b10000111100001111";
        ram[151] = "0b00000000000000000";
        ram[152] = "0b00000000000000000";
        ram[153] = "0b10000111100001111";
        for (unsigned i = 154; i < 165 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[165] = "0b10000111100001111";
        ram[166] = "0b00000000000000000";
        ram[167] = "0b00000000000000000";
        ram[168] = "0b00000000000000000";
        ram[169] = "0b00000000000000000";
        ram[170] = "0b10000111100001111";
        for (unsigned i = 171; i < 180 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[180] = "0b10000111100001111";
        for (unsigned i = 181; i < 187 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[187] = "0b10000111100001111";
        for (unsigned i = 188; i < 195 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[195] = "0b10000111100001111";
        for (unsigned i = 196; i < 204 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[204] = "0b10000111100001111";
        for (unsigned i = 205; i < 210 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[210] = "0b10000111100001111";
        for (unsigned i = 211; i < 221 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[221] = "0b10000111100001111";
        ram[222] = "0b00000000000000000";
        ram[223] = "0b00000000000000000";
        ram[224] = "0b00000000000000000";
        ram[225] = "0b10000111100001111";
        for (unsigned i = 226; i < 238 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ram[238] = "0b10000111100001111";
        for (unsigned i = 239; i < 256 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
...
SC_MODULE(apply_watermark_compute_watermark_watermark_ROM_AUTO_1R) {
...
apply_watermark_compute_watermark_watermark_ROM_AUTO_1R_ram* meminst;


SC_CTOR(apply_watermark_compute_watermark_watermark_ROM_AUTO_1R) {
meminst = new apply_watermark_compute_watermark_watermark_ROM_AUTO_1R_ram("apply_watermark_compute_watermark_watermark_ROM_AUTO_1R_ram");
