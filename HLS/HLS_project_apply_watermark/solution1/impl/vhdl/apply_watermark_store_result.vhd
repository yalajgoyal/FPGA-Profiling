...
entity apply_watermark_store_result is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of apply_watermark_store_result is 
...
attribute shreg_extract : string;
    ...
    signal grp_store_result_Pipeline_mem_wr_fu_66_ap_start : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_ap_done : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_ap_idle : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_ap_ready : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_outStream_read : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWVALID : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WVALID : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WLAST : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARVALID : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_RREADY : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_BREADY : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_66_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal sext_ln139_fu_85_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component apply_watermark_store_result_Pipeline_mem_wr IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        m_axi_gmem1_BID : IN STD_LOGIC_VECTOR (0 downto 0);
        m_axi_gmem1_BUSER : IN STD_LOGIC_VECTOR (0 downto 0);
        sext_ln139 : IN STD_LOGIC_VECTOR (57 downto 0) );
    end component;



begin
    grp_store_result_Pipeline_mem_wr_fu_66 : component apply_watermark_store_result_Pipeline_mem_wr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_store_result_Pipeline_mem_wr_fu_66_ap_start,
        ap_done => grp_store_result_Pipeline_mem_wr_fu_66_ap_done,
        ap_idle => grp_store_result_Pipeline_mem_wr_fu_66_ap_idle,
        ap_ready => grp_store_result_Pipeline_mem_wr_fu_66_ap_ready,
        outStream_dout => outStream_dout,
        outStream_num_data_valid => ap_const_lv2_0,
        outStream_fifo_cap => ap_const_lv2_0,
        outStream_empty_n => outStream_empty_n,
        outStream_read => grp_store_result_Pipeline_mem_wr_fu_66_outStream_read,
        m_axi_gmem1_AWVALID => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWVALID,
        m_axi_gmem1_AWREADY => m_axi_gmem1_AWREADY,
        m_axi_gmem1_AWADDR => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWADDR,
        m_axi_gmem1_AWID => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWID,
        m_axi_gmem1_AWLEN => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLEN,
        m_axi_gmem1_AWSIZE => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWSIZE,
        m_axi_gmem1_AWBURST => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWBURST,
        m_axi_gmem1_AWLOCK => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLOCK,
        m_axi_gmem1_AWCACHE => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWCACHE,
        m_axi_gmem1_AWPROT => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWPROT,
        m_axi_gmem1_AWQOS => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWQOS,
        m_axi_gmem1_AWREGION => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWREGION,
        m_axi_gmem1_AWUSER => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWUSER,
        m_axi_gmem1_WVALID => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WVALID,
        m_axi_gmem1_WREADY => m_axi_gmem1_WREADY,
        m_axi_gmem1_WDATA => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WDATA,
        m_axi_gmem1_WSTRB => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WSTRB,
        m_axi_gmem1_WLAST => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WLAST,
        m_axi_gmem1_WID => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WID,
        m_axi_gmem1_WUSER => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WUSER,
        m_axi_gmem1_ARVALID => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARVALID,
        m_axi_gmem1_ARREADY => ap_const_logic_0,
        m_axi_gmem1_ARADDR => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARADDR,
        m_axi_gmem1_ARID => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARID,
        m_axi_gmem1_ARLEN => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARLEN,
        m_axi_gmem1_ARSIZE => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARSIZE,
        m_axi_gmem1_ARBURST => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARBURST,
        m_axi_gmem1_ARLOCK => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARLOCK,
        m_axi_gmem1_ARCACHE => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARCACHE,
        m_axi_gmem1_ARPROT => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARPROT,
        m_axi_gmem1_ARQOS => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARQOS,
        m_axi_gmem1_ARREGION => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARREGION,
        m_axi_gmem1_ARUSER => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_ARUSER,
        m_axi_gmem1_RVALID => ap_const_logic_0,
        m_axi_gmem1_RREADY => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_RREADY,
        ...
        m_axi_gmem1_BREADY => grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_BREADY,
        m_axi_gmem1_BRESP => m_axi_gmem1_BRESP,
        m_axi_gmem1_BID => m_axi_gmem1_BID,
        m_axi_gmem1_BUSER => m_axi_gmem1_BUSER,
        sext_ln139 => trunc_ln_reg_95);
    ...
    grp_store_result_Pipeline_mem_wr_fu_66_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_store_result_Pipeline_mem_wr_fu_66_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                    grp_store_result_Pipeline_mem_wr_fu_66_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_store_result_Pipeline_mem_wr_fu_66_ap_ready = ap_const_logic_1)) then 
                    grp_store_result_Pipeline_mem_wr_fu_66_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem1_AWREADY, m_axi_gmem1_BVALID, out_r_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state72, grp_store_result_Pipeline_mem_wr_fu_66_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (grp_store_result_Pipeline_mem_wr_fu_66_ap_done = ap_const_logic_1))) then
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_ap_done)
    begin
        if ((grp_store_result_Pipeline_mem_wr_fu_66_ap_done = ap_const_logic_0)) then 
    ...
    grp_store_result_Pipeline_mem_wr_fu_66_ap_start <= grp_store_result_Pipeline_mem_wr_fu_66_ap_start_reg;
    ...
    m_axi_gmem1_AWADDR_assign_proc : process(m_axi_gmem1_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWADDR, ap_CS_fsm_state3, ap_CS_fsm_state4, sext_ln139_fu_85_p1)
    begin
        if (((m_axi_gmem1_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem1_AWADDR <= sext_ln139_fu_85_p1;
    ...
    m_axi_gmem1_AWBURST_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWBURST, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
    ...
    m_axi_gmem1_AWCACHE_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWCACHE, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWCACHE <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWCACHE;
        else 
    ...
    m_axi_gmem1_AWID_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWID <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWID;
        else 
    ...
    m_axi_gmem1_AWLEN_assign_proc : process(m_axi_gmem1_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLEN, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((m_axi_gmem1_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem1_AWLEN <= ap_const_lv32_7B50;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWLEN <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLEN;
        else 
    ...
    m_axi_gmem1_AWLOCK_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLOCK, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWLOCK <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWLOCK;
        else 
    ...
    m_axi_gmem1_AWPROT_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWPROT, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWPROT <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWPROT;
        else 
    ...
    m_axi_gmem1_AWQOS_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWQOS, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWQOS <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWQOS;
        else 
    ...
    m_axi_gmem1_AWREGION_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWREGION, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWREGION <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWREGION;
        else 
    ...
    m_axi_gmem1_AWSIZE_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWSIZE, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWSIZE <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWSIZE;
        else 
    ...
    m_axi_gmem1_AWUSER_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWUSER, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_AWUSER <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWUSER;
        else 
    ...
    m_axi_gmem1_AWVALID_assign_proc : process(m_axi_gmem1_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_AWVALID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((m_axi_gmem1_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    m_axi_gmem1_BREADY_assign_proc : process(m_axi_gmem1_BVALID, ap_CS_fsm_state72, grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_BREADY, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem1_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem1_WVALID_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WVALID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem1_WVALID <= grp_store_result_Pipeline_mem_wr_fu_66_m_axi_gmem1_WVALID;
        else 
    ...
    outStream_read_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_66_outStream_read, ap_CS_fsm_state4)
    begin
    ...
    begin
        ...
        sext_ln139_fu_85_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_95),64));
