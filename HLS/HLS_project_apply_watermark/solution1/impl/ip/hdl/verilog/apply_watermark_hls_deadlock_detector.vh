...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    apply_watermark_hls_deadlock_detect_unit #(4, 0, 2, 2) apply_watermark_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    apply_watermark_hls_deadlock_detect_unit #(4, 1, 2, 2) apply_watermark_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~load_input_U0.grp_load_input_Pipeline_image_traverse_fu_59.inStream_blk_n) | (~load_input_U0.grp_load_input_Pipeline_image_traverse_fu_59.xStream_blk_n) | (~load_input_U0.grp_load_input_Pipeline_image_traverse_fu_59.yStream_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_compute_watermark_U0_U.if_full_n & load_input_U0.ap_start & ~load_input_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_compute_watermark_U0_U.if_read);
    ...
    // Process: compute_watermark_U0
    apply_watermark_hls_deadlock_detect_unit #(4, 2, 2, 2) apply_watermark_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~compute_watermark_U0.inStream_blk_n) | (~compute_watermark_U0.xStream_blk_n) | (~compute_watermark_U0.yStream_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_compute_watermark_U0_U.if_empty_n & compute_watermark_U0.ap_idle & ~start_for_compute_watermark_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~compute_watermark_U0.outStream_blk_n);
    ...
    apply_watermark_hls_deadlock_detect_unit #(4, 3, 2, 2) apply_watermark_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~store_result_U0.grp_store_result_Pipeline_mem_wr_fu_66.outStream_blk_n);
...
`include "apply_watermark_hls_deadlock_report_unit.vh"
